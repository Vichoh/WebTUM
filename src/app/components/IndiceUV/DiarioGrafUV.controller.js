(function () {
  'use strict';
  angular.module('app')
  .controller('DiarioGrafUV.controller', diaGrafUVCtrl);

  diaGrafUVCtrl.$inject = ['buscarPorDiaService', '$log'];

  function diaGrafUVCtrl(buscarPorDiaService, $log) {
    var vm = this;
    vm.location = 'bar';
    var fecha = new Date();
